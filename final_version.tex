...
\setbeamertemplate{background}{\tikz[overlay,remember picture, anchor=center]\node[opacity=.15]at ([yshift=0cm]current page.center){\includegraphics[width=3cm]{images/sapienza-logo.png}};}
...
%------------------------------------------------
{
\setbeamertemplate{background}{\tikz[overlay,remember picture, anchor=center]\node[opacity=1]at ([yshift=-0.5cm]current page.center){\includegraphics[width=0.9\linewidth]{images/framework.png}};}
...
%------------------------------------------------
{
\setbeamertemplate{background}{\tikz[overlay,remember picture, anchor=center]\node[opacity=0.3]at ([yshift=-0.5cm]current page.center){\includegraphics[width=0.9\linewidth]{images/framework.png}};}
...
%------------------------------------------------
{
\setbeamertemplate{background}{\tikz[overlay,remember picture, anchor=center]\node[opacity=1]at ([yshift=0cm]current page.center){\includegraphics[width=0.9\linewidth]{images/LOCcoverage.png}};}
...
%------------------------------------------------
{
%\setbeamertemplate{background}{\tikz[overlay,remember picture, anchor=center]\node[opacity=0.25]at ([yshift=0cm]current page.center){\includegraphics[width=0.9\linewidth]{images/LOCcoverage.png}};}
